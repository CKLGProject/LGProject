...
namespace NKStudio
{
    [CustomPropertyDrawer(typeof(UDictionary<,>.KvP))]
    public class KeyValuePairPropertyDrawer : PropertyDrawer
    {
        ...
        {
            keyProp = property.FindPropertyRelative(nameof(UDictionary<int, int>.KvP.key));
            valueProp = property.FindPropertyRelative(nameof(UDictionary<int, int>.KvP.value));
            duplicateProp = property.FindPropertyRelative(nameof(UDictionary<int, int>.KvP.duplicatedKey));
        }
